...
//	char* filename = NULL;
//    vmi_read_64_va(vmi_os.vmi, parent_dentry_addr+vmi_os.d_subdirs_dentry_offset, 0, &subdirs_head);//�õ���һ�������ͷ
//
//    int i=0;
//    plist=subdirs_head;
//    vmi_read_addr_va(vmi_os.vmi,plist,0,&plist);
//    for(;plist!=subdirs_head;vmi_read_addr_va(vmi_os.vmi,plist,0,&plist))//������������
//    {
//        //vmi_read_addr_va(vmi,plist-vmi_os.d_child_dentry_offset,0,&next_dentry_addr);//�õ���һ��dentry
...
//					parentNode->subdirs.next=&(newNode->bro);//��Ŀ¼����ָ
...
//
//				addr_t temp_subdirs;
//				vmi_read_64_va(vmi_os.vmi,plist-vmi_os.d_child_dentry_offset+vmi_os.d_subdirs_dentry_offset, 0, &temp_subdirs);//�õ���һ�������ͷ
//				if(temp_subdirs!=(plist-vmi_os.d_child_dentry_offset+vmi_os.d_subdirs_dentry_offset))//����һ��Ŀ¼�ŵݹ�
//				{
...
//// 	addr_t plist,subdirs_head,temp_name,temp_inode,d_child_list,next_dentry_addr;
//// 	char* filename = NULL;
//// 	vmi_read_64_va(vmi_os.vmi, ls_addr+vmi_os.d_subdirs_dentry_offset, 0, &subdirs_head);//�õ���һ�������ͷ
//
////     int i=0;
////     plist=subdirs_head;
////     vmi_read_addr_va(vmi_os.vmi,plist,0,&plist);
